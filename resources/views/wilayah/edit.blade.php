            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="card w-100">
                        <div class="card-body">
                            <form action="{{ route('datawilayah.update',$datawilayah->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="form-group">
                                <label for="nama">Nama Wilayah</label>
                                    <input type="text" name="nama"
                                        class="form-control @error('nama') is-invalid @enderror" value="{{$datawilayah->nama}}">
                                    @error('nama')
                                ...
                                <div class="form-group">
                                    <label for="nama">Tingkatan Wilayah</label>
                                        ...
                                        <select name="tingkatan_wilayah_id" id="tingkatan_wilayah_id" class=" @error('tingkatan_wilayah_id') is-invalid @enderror js-example-basic-single w-100">
                                            ...
                                            <option value="{{$item->id}}" {{$item->id == $datawilayah->id ? 'selected' : ''}}>{{$item->nama}}</option>
                                            @endforeach
                                        </select>
                                        @error('nama')
                                            <div class="invalid-feedback">
