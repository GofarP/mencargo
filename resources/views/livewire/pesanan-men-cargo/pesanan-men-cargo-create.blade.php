        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-12">
                <div class="form-group">
                    ...
                    <input type="text" id="resi" name="resi" class="form-control" required autofocus>
                </div>
            </div>
            <div class="col-xl-3 col-lg-3 col-md-6 col-12">
                <div class="form-group">
                    ...
                    data-component-id="{{ $this->getId() }}" class="form-control" required autofocus>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-12">
                <div class="form-group">
                    ...
                    <select data-pharaonic="select2" name="metode_pembayaran_id" data-component-id="{{ $this->getId() }}"
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-12">
                <div class="form-group">
                    ...
                    <select data-pharaonic="select2" name="status_pembayaran" data-component-id="{{ uniqid() }}" class="form-control" required>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-12">
                <div class="form-group">
                    ...
                    <input type="number" name="harga_kg_barang" class="form-control" required>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-12">
                <div class="form-group">
                    ...
                    <input type="number" name="harga_unit" class="form-control" required>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-12">
                <div class="form-group">
                    ...
                    <input type="number" name="uang_sisa" class="form-control" readonly value="0">
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-12">
                <div class="form-group">
                    ...
                    <input type="date" name="waktu_pesan" class="form-control" required>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-12">
                <div class="form-group">
                    ...
                    <input type="number" name="jumlah_koli_awal" class="form-control" required>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-12">
                <div class="form-group">
                    ...
                    <input type="number" name="jumlah_koli_packing" class="form-control" required>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-12">
                <div class="form-group">
                    ...
                    <input type="number" name="dimensi" class="form-control" required>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-12">
                <div class="form-group">
                    ...
                    <input type="number" name="instruksi" class="form-control" required>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-12">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="notelp_penerima" required>
                </div>
            </div>
